...
const NotFound = () => {
    return (<>
        ...
        <section className="py-12 py-sm-24 py-md-32 overflow-hidden">
            <div className="container position-relative">
                ...
                <div className="position-relative mw-lg mx-auto px-8 px-md-20 pt-10 pb-14 bg-white text-center rounded-4 shadow-lg">
                    ...
                    <Link className="btn p-0 btn-link fw-light d-inline-flex align-items-center" to={"/"}>
                        ...
                        <span className="ms-2">Go Back to Homepage</span>
                    </Link>
                </div>
            </div>
        </section>
